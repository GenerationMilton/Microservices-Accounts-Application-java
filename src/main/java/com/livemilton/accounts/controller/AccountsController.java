...
@Tag(name = "CRUD REST APIs for Accounts in livemiltonBank", description = "CRUD REST APIs in livemiltonBank to CREATE, UPDATE, FETCH AND DELETE account details")
@RestController
...
public class AccountsController {
        ...
        @Operation(summary = "Update Account Detailes REST API", description = "REST API to update Customer & Account details based on a account number")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
